...
namespace HM.Form_.Old
{
    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// </summary>
        public BseRenderer()
            : base(new HM.Form_.Old.ColorTableBlack())
        {
        ...
        /// </summary>
        /// <param name="professionalColorTable">A <see cref="HM.Form_.Old.ProfessionalColorTable"/> to be used for painting.</param>
        ...
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            ...
            {
                ProfessionalColorTable colorTable = ColorTable as HM.Form_.Old.ProfessionalColorTable;
