...
namespace HM.Form_.Old
{
    ...
    public class ToolStripProgressBar : ToolStripControlHost
    {
        ...
        /// </summary>
        /// <value>
        /// Type: <see cref="HM.Form_.Old.ProgressBar"/>
        /// A ProgressBar.
        /// </value>
        ...
        /// <summary>
        /// Gets or sets the text displayed on the <see cref="HM.Form_.Old.ToolStripProgressBar"/>.
        /// </summary>
        /// <value>
        ...
        {
            HM.Form_.Old.ProgressBar progressBar = new HM.Form_.Old.ProgressBar();
